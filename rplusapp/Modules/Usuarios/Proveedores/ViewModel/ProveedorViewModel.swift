...
class ProveedorViewModel {
    ...
    func requestGetProveedor(paramTypeUrl: Int? = 0) {
        print("inicio")
        ProveedorWS().getProveedorListByLimit(idTypeURL: paramTypeUrl ?? 0, completion: { (dataResponse, error) in
