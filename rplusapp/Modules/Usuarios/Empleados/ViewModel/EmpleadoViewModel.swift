...
class EmpleadoViewModel {
    ...
    func requestGetEmpleado(paramTypeUrl: Int? = 0) {
        print("inicio")
        EmpleadoWS().getEmpleadoListByLimit(idTypeURL: paramTypeUrl ?? 0, completion: { (dataResponse, error) in
