...
class PasesAsignadosViewModel {
    ...
    var listArray : [DataPaseAsignado] = []{
    ...
    func requestGetPasesAsignados() {
        print("inicio")
        
        PasesAsignadosWS().getPasesAsignadosList(completion: { (dataResponse, error) in
